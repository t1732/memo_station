(function() {
    ...
    function main() {
        ...
        // URLは & を含むためエンコードが必要
window.open('<%= server_url_for :action => "new" %>?subject=' + encodeURIComponent(document.title) + '&amp;url=' + encodeURIComponent(location.href) + '&amp;body=' + encodeURIComponent(selected_text), '_blank');
    }
