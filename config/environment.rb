...
# 作者
AuthorMail = "pinpon.ikeda@gmail.com"
AuthorName = "Akira Ikeda"

# 自宅
AdminName = "池田 晃"
AdminMail = "ikeda@localhost"

MAIL_FROM = "ikeda@localhost"
MAIL_RECIPIENTS = "ikeda@localhost"
...
require "taggable" # acts_as_taggable は lib/acts_as_taggable.rb じゃなくて lib/taggable.rb になっているため
...
RAILS_DEFAULT_LOGGER.info("loaded: #{__FILE__}, env: #{RAILS_ENV}")

# RAILS_GEM_VERSION 1.2 なら不要
class Module
